if (!self.define) {
  ...
  self.define = (r, c) => {
    ...
    let n = {};
    const i = (s) => a(s, t),
      f = { module: { uri: t }, exports: n, require: i };
    e[t] = Promise.all(r.map((s) => f[s] || i(s))).then((s) => (c(...s), n));
  };
}
define(["./workbox-8a9ef17b"], function (s) {
  "use strict";
    ...
    s.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: "03ccae6a09acf2d1cdc9b11b90bfedd5",
        },
        {
          url: "assets/stamps/teachers_chance_02.png",
          revision: "4ba6e940d67fed74359bf07284a21f5f",
        },
        {
          url: "assets/stamps/teachers_chance_03.png",
          revision: "60680740de604f2e9a19fd31f0fdb60a",
        },
        {
        ...
        },
        {
          ...
          revision: "0aee384b503e875df92d23e8aa26568f",
        },
        {
          url: "assets/stamps/teachers_katrina_02.png",
          revision: "297446afe91705bd4d4bf373fd02e561",
        },
        {
          url: "assets/stamps/teachers_katrina_03.png",
          revision: "e8190aa8c33763b6460280a56dab9c58",
        },
        {
          url: "assets/stamps/teachers_kuni_01.png",
          revision: "dff9b75e1de1f3ca0f1d60d70c228732",
        },
        {
          url: "assets/stamps/teachers_kuni_02.png",
          revision: "1547add4a7445c1bce9a6363c472f2c2",
        },
        {
          url: "assets/stamps/teachers_kuni_03.png",
          revision: "b2de20dc6f77bfe1f61480cf402960c2",
        },
        {
        ...
        },
        {
          ...
          revision: "9c60459c23ad2141191e7b99287449c9",
        },
        {
          url: "assets/stamps/teachers_mike_02.png",
          revision: "c7b63bc1f4e22d4d50ee9cadd2217061",
        },
        {
          url: "assets/stamps/teachers_mike_03.png",
          revision: "621f019308f31cfdeccc06693d4e4cbb",
        },
        {
        ...
        },
        {
          ...
          revision: "7a5a33d1d267347ed2118e9d27dbbea7",
        },
        { url: "favicon.png", revision: "df91dc163c369f33f94340a06d5e0964" },
        {
        ...
        { url: "global.css", revision: "d2c6fe8e729548a914dee9bc8adc93cc" },
        { url: "index.html", revision: "70f057b3c43fac3a003479cb20d31b84" },
        { url: "logo.png", revision: "21d40c1e0d9e5724ba49f277a8ae483f" },
        { url: "manifest.json", revision: "93c368ea106ff7a0e8c666f09eb334ff" },
        { url: "offline.html", revision: "65e942e3cfc99e7d3432d3939bc66a09" },
      ],
